...
public class NotificationService extends NotificationListenerService {
    ...
    public void onCreate() {
        ...
        if (MainActivity.instance != null)
            MainActivity.instance.addLog("[SERVICE] Démarré - Multi-sources + Validation croisée + Corrélation ACTIVÉ");
    }
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        // ✨ NOUVEAU: Corrélation avec calendrier
        correlateWithCalendar(eventId, detectCountry(combined), assets, 
                              detectedEvent.impact, validation.confidence);
    ...
    private void correlateWithCalendar(String notificationEventId, String country, 
                                       ...
                                       int confidence) {
        try {
            // Récupérer événements du calendrier dans la prochaine heure
            List<EconomicCalendarAPI.CalendarEvent> upcomingEvents = 
                EconomicCalendarAPI.fetchUpcomingEvents(1);
