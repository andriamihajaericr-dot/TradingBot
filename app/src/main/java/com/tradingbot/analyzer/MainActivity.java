...
public class MainActivity extends AppCompatActivity {
    ...
    public static String MACRO_API_KEY    = ""; // ← AJOUT : Variable statique locale
    ...
    private EditText apiKeyInput, macroApiKeyInput, telegramTokenInput, telegramChatIdInput; // ← AJOUT : macroApiKeyInput
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        macroApiKeyInput    = findViewById(R.id.macroApiKeyInput); // ← AJOUT : Liaison XML (Nécessite d'ajouter un EditText dans activity_main.xml avec cet ID)
        ...
        testBtn.setOnClickListener(v -> {
            ...
            try {
                // Passage du "this" (contexte de l'activité) pour permettre la lecture sécurisée des SharedPreferences par la méthode POST
    ...
    private void saveKeys() {
        ...
        String m = macroApiKeyInput.getText().toString().trim(); // ← AJOUT : Lecture du champ macro
        ...
        // Sauvegarde unifiée dans les SharedPreferences sous les exacts mêmes labels lus par le NotificationService
        getPrefs().edit()
            .putString("claude_key", k)
            .putString("macro_api_key", m) // ← AJOUT : Sauvegarde persistante
